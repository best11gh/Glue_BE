...
public enum ChatResponseStatus implements ResponseStatus {
    // Success responses
    CHATROOM_CREATED(HttpStatus.CREATED, true, 201, "채팅방을 성공적으로 생성하였습니다"),
    CHATROOM_JOINED(HttpStatus.OK, true, 200, "채팅방에 성공적으로 참여하였습니다"),
    CHATROOM_LEFT(HttpStatus.OK, true, 200, "채팅방에서 성공적으로 퇴장하였습니다"),
    NOTIFICATION_TOGGLED(HttpStatus.OK, true, 200, "알림 설정이 성공적으로 변경되었습니다"),
    MESSAGE_SENT(HttpStatus.CREATED, true, 201, "메시지가 성공적으로 전송되었습니다"),
    MESSAGES_READ(HttpStatus.OK, true, 200, "메시지를 성공적으로 읽음 처리하였습니다"),
    CHATROOM_FOUND(HttpStatus.OK, true, 200, "채팅방을 성공적으로 조회하였습니다"),
