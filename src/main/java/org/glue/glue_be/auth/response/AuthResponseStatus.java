...
public enum AuthResponseStatus implements ResponseStatus {
    ...
    INVALID_ACCESS_TOKEN(HttpStatus.UNAUTHORIZED, false, 401, "Access Token이 유효하지 않습니다."),
    ...
    // 신고 누적 관련
    BLOCKED_BY_REPORT(HttpStatus.FORBIDDEN, false, 403, "신고 누적으로 인해 로그인이 제한된 사용자입니다.");
